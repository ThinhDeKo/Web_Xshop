...
<?php
    $select = "SELECT product.*,category.name_category FROM product INNER JOIN category 
                ON product.id_category = category.id_category where product.id_category = 2 ORDER BY product.id_product desc";
...
<div class="content-wrapper">
    <h1>Sản Phẩm</h1>
    <a href="add_samsung.php" style="margin-left: 20px"><button>Thêm sản phẩm ++</button></a>
