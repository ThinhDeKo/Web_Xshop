...
<?php require_once './inc/slidebar.php'; ?>
	...
	<?php
		$sql = "SELECT * FROM product WHERE special = 1 AND id_category = 1";
		$st = $conn->prepare($sql);
		$st->execute();
		$pr_ip = $st->fetchAll();
		...
		$sp->execute();
		$sp_ip = $sp->fetchAll();
		$query = "SELECT * FROM product WHERE special = 1 AND id_category = 2";
				...
				<div class="agileinfo-ads-display col-lg-9">
					<div class="wrapper">
						...
						<div class="product-sec1 px-sm-4 px-3 py-sm-5  py-3 mb-4">
							<h3 class="heading-tittle text-center font-italic"><strong>Điện thoại di động</strong></h3>
							<div class="row">
								<!--  -->
						...
						<div class="">
							<div class="row">
								<!-- <h3 class=" effect-bg">Summer Carnival</h3>
								<p class="w3l-nut-middle">Get Extra 10% Off</p> -->
								<div class="col-md-12 bg-right-nut">
									<img src="images/ip13_banner.jfif" alt="" width="820px">
								</div>
							</div>
						</div>
						<!-- //third section -->
					...
					<div class="join-agile text-left p-4"style="background-color: #fff;">
						<div class="row">
							<div class="col-sm-7 offer-name">
								...
								<p>Giá mới nhất chỉ từ: <strong>21.990.000 <ins>đ</ins></strong></p>
							</div>
