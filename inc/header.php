...
<head>
	...
	<link rel="shortcut icon" href="images/favicon2.png" type="image/x-icon" width="500px">
	<link rel="stylesheet" href="../Form/Form/style.css">
	<link rel="stylesheet" href="../Form/Form/grid.css">
	<!-- Meta tag Keywords -->
				...
				<div class="col-lg-8 header-right mt-lg-0 mt-2">
					...
					<ul>
						...
						<li class="text-center text-white">
							<a href="dki.php" class="text-white">
		...
		<div class="container">
			<div class="row header-bot_inner_wthreeinfo_header_mid">
				...
				<div class="col-md-3">
					...
					<a href="">
						<img src="images/<?php echo $inf['logo'] ?>" alt="" width="130px">
					</a>
					</h1>
				</div>
				<!-- //logo -->
				...
				<div class="collapse navbar-collapse" id="navbarSupportedContent">
					...
					<ul class="navbar-nav ml-auto text-center mr-xl-5">
						...
						<i class="ri-home-4-fill" style="font-size: 30px;"></i>
							<a class="nav-link" href="index.php"><strong>TRANG CHỦ</strong>
							</a>
						</li>
						...
						<!-- <i class="ri-apple-fill" style="font-size: 30px;"></i> -->
							<a class="nav-link dropdown-toggle" href="../web/iphone.php" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
						...
						<!-- <li class="nav-item mr-lg-2 mb-lg-0 mb-2" style="margin: 0px 20px">
							<i class="fas fa-book" style="font-size: 27px;padding-top: 9.5px;padding-bottom: 9px"></i><br>
							<a class="nav-link" href="warranty.php"><strong>CHÍNH SÁCH</strong></a>
							<div class="dropdown-menu">
								<div class="agile_inner_drop_nav_info p-4">
								</div>
							</div>
